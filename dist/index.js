...
const Content = () => {
    ...
    const lastCountRef = SP_REACT.useRef(null);
    const handleInternalToggle = async (currentStatus) => {
    ...
    return (SP_JSX.jsxs(SP_JSX.Fragment, { children: [SP_JSX.jsx(DFL.PanelSection, { title: "Internal Controller", children: SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { layout: "below", onClick: () => handleInternalToggle(isBound), disabled: isToggling === "internal" || (isBound && activeExternalCount === 0), children: SP_JSX.jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: "10px" }, children: [isBound ? SP_JSX.jsx(FaToggleOn, { color: "#66ff66" }) : SP_JSX.jsx(FaToggleOff, { color: "#ff4444" }), isToggling === "internal" ? "Working..." : (isBound ? "Internal: ACTIVE" : "Internal: HIDDEN")] }) }) }) }), SP_JSX.jsx(DFL.PanelSection, { title: "External Devices", children: externalCtrls.length === 0 ? (SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx("div", { style: { opacity: 0.5, textAlign: "center", width: "100%", fontSize: "0.85em", padding: "10px" }, children: "No USB controllers detected" }) })) : (externalCtrls.map((ctrl) => (SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "10px", width: "100%", padding: "5px 0" }, children: [SP_JSX.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "12px" }, children: [SP_JSX.jsx(FaGamepad, { color: ctrl.is_bound ? "#3b82f6" : "#555", size: 20 }), SP_JSX.jsxs("div", { style: { display: "flex", flexDirection: "column" }, children: [SP_JSX.jsx("span", { style: { fontSize: "0.95em", fontWeight: "bold" }, children: ctrl.name }), SP_JSX.jsxs("span", { style: { fontSize: "0.7em", opacity: 0.5 }, children: ["ID: ", ctrl.id] })] })] }), SP_JSX.jsx(DFL.ButtonItem, { layout: "below", onClick: async () => {
                                    setIsToggling(ctrl.id);
                                    await toggleController(ctrl.is_bound, ctrl.id);
                                    setIsToggling(null);
                                    refreshStatus();
                                }, disabled: isToggling !== null || (!isBound && ctrl.is_bound && activeExternalCount === 1), children: ctrl.is_bound ? SP_JSX.jsxs(SP_JSX.Fragment, { children: [SP_JSX.jsx(FaUnlink, {}), " Unbind"] }) : SP_JSX.jsxs(SP_JSX.Fragment, { children: [SP_JSX.jsx(FaLink, {}), " Bind"] }) })] }) }, ctrl.id)))) })] }));
};
var index = definePlugin(() => ({ name: "ControllerPriority", content: SP_JSX.jsx(Content, {}), icon: SP_JSX.jsx(FaGamepad, {}) }));
